...
insert into crianca (cpf, nome, data_nascimente) values ('aaa', 'pedrinho', to_date('1980-01-01', 'YYYY-MM-DD'));
...
insert into gratificacao (cmf, datahora, valor) values ('aaa', to_date('2023-05-20 12:30:12', 'yyyy/mm/dd hh24:mi:ss'), 100.50);
...
insert into assustar (cpf, cmf, data_susto) values ('aaa', 'aaa', to_date('2023-04-01', 'YYYY-MM-DD'));
...
insert into extrair (numero_serie, cpf, cmf, data_susto, data_extracao) values ('EXG-800-354', 'aaa', 'aaa', to_date('2023-04-01', 'YYYY-MM-DD'), to_date('2023-04-01 08:12:00', 'yyyy/mm/dd hh24:mi:ss'));